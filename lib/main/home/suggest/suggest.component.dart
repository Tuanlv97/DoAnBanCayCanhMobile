...
import 'suggest.page.dart';

class SuggestComponent extends StatelessWidget {
  final List<PlantModel> listPlant;

  const SuggestComponent({super.key, required this.listPlant});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              ButtonNotClickMulti(
                  onTap: () {
                    context.push(MainRouterPath.routerPlantPage, extra: DataPageModel(pageName: 'Gợi ý', listData: listPlant));
                  },
                  child: const Text(
                    "Xem tất cả >",
